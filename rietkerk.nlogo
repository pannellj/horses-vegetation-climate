globals [
  ...
  k1       ; half-saturation constant of specific plant growth and water uptake (mm)
  d        ; specific loss of plant density due to mortality (d^-1) between 0 and 0.5
  Dp       ; plant dispersal (m^2 d^-2)
  alpha    ; maximum infiltration rate (d^-1)
  k2       ; saturation constant of water infiltration (g m^-2)
  W0       ; water infiltration rate in the absence of plants (--)
  rw       ; specific soil water loss due to evaporation and drainage (d^-1)
...
to setup-patches
  ask patches [
    set plant-density random-float 1000
    set soil-water random-float 100
    set surface-water random-float 3
